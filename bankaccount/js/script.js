...
btnDeposit.onclick =  account1.depositAmount(); // SINCE WE RETURN THE FUNCTION,s USE ()

btnWithdrawal.addEventListener("click", account1.withdrawalAmount()); // THE SAME AS ABOVE
